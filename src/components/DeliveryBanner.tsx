  ...
  return (
    <section ref={bannerRef} className="relative py-20 px-6 opacity-0">
      <div className="mx-auto max-w-5xl">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-500 to-blue-600 p-10 shadow-2xl shadow-blue-500/30 sm:p-14">
          {/* Background decoration */}
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute -right-10 -top-10 h-60 w-60 rounded-full bg-white/10 blur-2xl" />
            <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-blue-400/30 blur-2xl" />
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center gap-6 text-center md:flex-row md:text-left">
            ...
            <div className="flex-1">
              ...
              <p className="text-base leading-relaxed text-blue-100/90 sm:text-lg">
            ...
            <a
              ...
              className="shrink-0 rounded-full bg-white px-8 py-4 text-base font-bold text-blue-700 shadow-lg transition-all hover:bg-blue-50 hover:shadow-xl hover:scale-105"
            >
              지금 시작하기
            </a>
          </div>

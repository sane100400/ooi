    ...
    <section id="process" ref={sectionRef} className="relative py-28 px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-16 text-center">
          ...
          <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-teal-200/60 bg-teal-50/80 px-5 py-2.5 dark:border-teal-700/50 dark:bg-teal-900/30">
            <svg className="h-4.5 w-4.5 text-teal-600 dark:text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-8 top-0 hidden h-full w-px bg-gradient-to-b from-emerald-200 via-emerald-400/60 to-emerald-200 dark:from-emerald-800 dark:via-emerald-600/60 dark:to-emerald-800 md:block" />
          ...
          <div className="space-y-8">
            {steps.map((step, i) => (
              ...
              >
                {/* Number circle */}
                <div className="relative z-10 flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-emerald-600 text-white shadow-md shadow-emerald-600/20">
                  {step.icon}
                </div>

                {/* Content */}
                <div className="flex-1 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-emerald-200/60 dark:border-emerald-800/20 dark:bg-emerald-900/10 dark:hover:border-emerald-700/40">
